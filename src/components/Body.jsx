...
const Body = () => {
  return (
    <div className='-space-y-4 lg:flex'>
      ...
      <div className='lg:flex-1 lg:order-1 lg:size-11 lg:px-8 py-8'>
        <h1 className='text-5xl font-bold font-playfair leading-tight'>Host your website in less than 5 minutes</h1>
        <p> With Hosterr,get your website up and running in no less than 5 minutes with the most competetive packages available online</p>
        <form action="" className='flex-col gap-4 md flex-row'>
